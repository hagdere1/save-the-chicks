(function () {
  ...
  var Car = ChickenRoad.Car = function (game, direction, pos) {
    ...
    this.height = 90;
    this.color = "purple";
    this.image_left_array = ["images/96A_mercedes_left.png", "images/batmanreturnsbatmobile4_left.png"];
    this.image_right_array = ["images/96A_mercedes_right.png", "images/batmanreturnsbatmobile4_right.png"];
    this.game = game;
  };
