(function () {
  ...
  var Car = ChickenRoad.Car = function (game, direction, pos) {
    ...
    this.height = 90;
    this.color = "purple";
    this.imageLeftArray = ["images/classy_blue_car_left.png", "images/silver_car_left.png", "images/blue_car_left.png", "images/96A_mercedes_left.png", "images/batmanreturnsbatmobile4_left.png", "images/old_car_left.png"];
    this.imageRightArray = ["images/silver_car_right.png", "images/blue_car_right.png", "images/96A_mercedes_right.png", "images/batmanreturnsbatmobile4_right.png", "images/old_car_right.png"];
    this.game = game;
  };
