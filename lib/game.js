(function () {
  ...
  Game.prototype.setEggsImage = function () {
    ...
    this.eggs.forEach(function (egg) {
      ...
      that.ctx.drawImage(eggIMG, egg.pos[0], egg.pos[1]);
    });
  };
  ...
  Game.prototype.drawTimer = function () {
    ...
    if (this.minutes > 0) {
      ...
      if (this.seconds > 9) {
        this.ctx.fillText("Time Remaining: " + minutes + ":" + remainder, 100, 30);
      }
      else {
        this.ctx.fillText("Time Remaining: " + minutes + ":0" + remainder, 100, 30);
      }
    }
    else {
      if (this.seconds > 9) {
        this.ctx.fillText("Time Remaining: " + minutes + ":" + this.seconds, 100, 30);
      }
      else {
        this.ctx.fillText("Time Remaining: " + minutes + ":0" + this.seconds, 100, 30);
      }
    }
  };
